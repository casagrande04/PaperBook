...
!["Primeira modelagem no excel"](excel-print-1.png)

#### Modelagem conceitual no excel - 1ºNormalização
!["Primeira normalização no excel"](excel-print-2.png)

#### Modelagem conceitual no excel - 2ºNormalização
!["Segunda nomralização no excel"](excel-print-3.png)
...
!["Segunda modelagem"](word-diagarama-paperbook.png)
...
!["Modelagem lógica - Diagrama"](diagrama_paperbook_casao.png)
